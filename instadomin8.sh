...
banner() {
    figlet InstaDomin8
printf "\n"
printf "\e[1;77m\e[41m  Instagram Brute Forcer , Author: Malwareman  \e[0m\n" 
}
...
printf "\e[1;92mUse ./instadomin8.sh --resume\n"
else
exit 1
fi
else
